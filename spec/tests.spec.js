...
describe('Unit tests for radRouter', () => {
  ...
  it('should add a new dio', (done) => {
    ...
    request(app)
      ...
      .end(async (err, res) => {
        ...
        await pool.query(
          "DELETE FROM dio WHERE sifra_dijela=$1;",
  ...
  it('should delete a dio', (done) => {
    ...
    pool.query(
      ...
      [dio.nazivDio, dio.kolicinaNaLageru]).then(rez=>{
      ...
      request(app)
        ...
        .end(async (err, res) => {
          ...
          const {rows}= await pool.query("SELECT * FROM dio WHERE sifra_dijela=$1;", [id]);
      ...
      [dio.nazivDio, dio.kolicinaNaLageru]).then(rez=>{
        ...
        request(app)
          ...
          .end(async (err, res) => {
            ...
            expect(updatedDio.kolicina_na_lageru).toEqual(newDio.kolicinaNaLageru);
  ...
  it('should add a new projekt', (done) => {
    ...
    request(app)
      ...
      .end(async (err, res) => {
        ...
        expect(addedProjekt.datum_pocetka.toLocaleDateString()).toEqual(projekt.datumPocetka.toLocaleDateString());
        expect(addedProjekt.datum_završetka.toLocaleDateString()).toEqual(projekt.datumZavršetka.toLocaleDateString());
  ...
  it('should delete a projekt', (done) => {
    ...
    pool.query(
      ...
      [projekt.nazivProjekta, projekt.opisProjekta, projekt.datumPocetka, projekt.datumZavršetka]).then(rez=>{
      ...
      request(app)
        ...
        .end(async (err, res) => {
          ...
          const {rows}= await pool.query("SELECT * FROM projekt WHERE sifra_projekta=$1;", [id]);
          expect(rows.length).toEqual(0);
          done();
        });
    });
      ...
      [projekt.nazivProjekta, projekt.opisProjekta, projekt.datumPocetka, projekt.datumZavršetka]).then(rez=>{
        ...
        request(app)
          ...
          .end(async (err, res) => {
            ...
            expect(updatedProjekt.naziv_projekta).toEqual(newProjekt.nazivProjekta);
            expect(updatedProjekt.opis_projekta).toEqual(newProjekt.opisProjekta);
            expect(updatedProjekt.datum_pocetka.toLocaleDateString()).toEqual(newProjekt.datumPocetka.toLocaleDateString());
            expect(updatedProjekt.datum_završetka.toLocaleDateString()).toEqual(newProjekt.datumZavršetka.toLocaleDateString());
      ...
      [projekt.nazivProjekta, projekt.opisProjekta, projekt.datumPocetka, projekt.datumZavršetka]).then(rez=>{
        ...
        request(app)
          ...
          .end(async (err, res) => {
            ...
            expect(new Date(res.body.datum_pocetka).toLocaleDateString()).toEqual(projekt.datumPocetka.toLocaleDateString());
            expect(new Date(res.body.datum_završetka).toLocaleDateString()).toEqual(projekt.datumZavršetka.toLocaleDateString());
